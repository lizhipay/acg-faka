!function () {
    ...
    $(`.send-phone-captcha`).click(function () {
        message.prompt({
            title: '人机验证',
            width: 420,
            html: `<img src="/user/captcha/image?action=phoneForgetCaptcha" onclick="this.src='/user/captcha/image?action=phoneForgetCaptcha&t=' + new Date().getTime()"  class="prompt-image-code" alt="${i18n('更换验证码')}">`,
            inputAttributes: {
