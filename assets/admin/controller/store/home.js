                        ...
                        <div class="layout-box">
                                        <div class="title">${i18n('付款购买')}</div>
                                            <div class="pay-list online-pay">
                                                ...
                                                <div data-id="0" data-type="2" data-pay="3" class="pay-item online-pay-click"${enterpriseDisabled}><img class="item-icon" src="/assets/common/images/okpay.png"><span>Okpay(${i18n('推荐')})</span></div>
                                            </div>
